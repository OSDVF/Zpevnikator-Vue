  ...
  <main class="container">
    <div class="row">
      ...
      <div class='col'>
        ...
        <a data-toggle="tooltip" class="text-secondary" title="Pokud vás zajímá proč to vůbec existuje, nebo byste rádi něčím přispěli, neváhejte napsat na o.s.dv.f@seznam.cz!">
